...
const FormularioPaciente = ({ roles }) => {
    ...
    const manejarCambio = (evento) => {
        ...
        // Si es cardiólogo o tiene rol de cardiología, mostramos directamente el formulario de cardiología
        if (isCardiologo || isCardiologia) {
            return (
                <form onSubmit={manejarSubmitCardiologia} className="w-full space-y-6">
                    ...
                    {/* Mostrar datos de Enfermería si ya existen */}
                    {datosEnfermeria && (
                        <>
...
// Si no es cardiólogo o no tiene rol de cardiología, mostramos el formulario de enfermería primero.
        return (
